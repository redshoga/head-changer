...
dnn_proto_text_path = os.path.normpath(os.path.join(base, '../assets/deploy.prototxt'))
dnn_model_path = os.path.normpath(os.path.join(base, '../assets/res10_300x300_ssd_iter_140000.caffemodel'))
mark_model_path = os.path.normpath(os.path.join(base, '../assets/frozen_inference_graph.pb'))
...
class MarkDetector:
    ...
    def __init__(self, mark_model=mark_model_path):
        """Initialization"""
